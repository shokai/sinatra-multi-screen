var MultiScreen = function(cometio, options){
  ...
  this[to].push = function(event_name, data){
    self.io.push("__multiscreen__event", {event: event_name, data: data, options: self.options});
  };
  ...
  if(options.type == "remote"){
    this.tv.event = function(selector, event_name, args){
      self.tv.push("__ui_event", {selector: selector, event: event_name, args: args});
    };
  ...
  if(options.type == "tv"){
    self.remote.on("__ui_event", function(data){
